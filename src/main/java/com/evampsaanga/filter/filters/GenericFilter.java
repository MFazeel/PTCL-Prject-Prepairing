package com.evampsaanga.filter.filters;

import com.evampsaanga.filter.dto.ResponseDto;
import com.evampsaanga.filter.utils.Constants;
import com.evampsaanga.filter.utils.SecureUtils;
...
public class GenericFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        logger.info("Inside My Filter Pre Handle URI: {}, Method: {}, Body: {}", requestWrapper.getRequestURI(), requestWrapper.getMethod(), requestBody);
        ...
        if (reqConfig.equals(sha256hex)) {
            ...
            String baseRes = responseDto.getResponseString()+salt+timestamp;
